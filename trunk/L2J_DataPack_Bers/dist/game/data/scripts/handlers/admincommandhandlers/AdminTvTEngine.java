...
public class AdminTvTEngine implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		else if (command.startsWith("admin_tvt_gift "))
		{
			TvT._rewardId = Integer.valueOf(command.substring(15));
			showMainPage(activeChar);
		}
		else if (command.startsWith("admin_tvt_gift_amount "))
		{
			TvT._rewardAmount = Integer.valueOf(command.substring(22));
			showMainPage(activeChar);
		}
		...
		else if (command.equals("admin_tvt_autoevent"))
		{
			if (!TvT._started)
			{
				...
				activeChar.sendMessage("A TvT Event has already been started.");
			showMainPage(activeChar);
		}
	...
	{
		final StringBuilder replyMSG = StringUtil.startAppend(1500, "<html><body>");
		...
		replyMSG.append("</tr></table><br><table><tr>");
		replyMSG.append("<td width=\"100\"><button value=\"Gift\" action=\"bypass -h admin_tvt_gift $input1\" width=90 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		replyMSG.append("<td width=\"100\"><button value=\"Gift Amount\" action=\"bypass -h admin_tvt_gift_amount $input1\" width=90 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		replyMSG.append("</tr></table><br><table><tr>");
		...
		replyMSG.append("Gift ID:&nbsp;<font color=\"00FF00\">" + TvT._giftId + "</font><br1>");
		replyMSG.append("Gift Amount:&nbsp;<font color=\"00FF00\">" + TvT._giftAmount + "</font><br><br>");
