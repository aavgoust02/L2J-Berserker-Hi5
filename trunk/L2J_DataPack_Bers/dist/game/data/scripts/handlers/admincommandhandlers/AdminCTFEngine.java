...
public class AdminCTFEngine implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		try
		{
			...
			else if (command.startsWith("admin_ctf_gift "))
			{
				CTF._giftId = Integer.valueOf(command.substring(15));

				showMainPage(activeChar);
			}
			else if (command.startsWith("admin_ctf_gift_amount "))
			{
				CTF._giftAmount = Integer.valueOf(command.substring(22));
				showMainPage(activeChar);
	...
	public void showEditPage(L2PcInstance activeChar)
	{
		...
		replyMSG.append("</tr></table><br><table><tr>");
		replyMSG.append("<td width=\"100\"><button value=\"Gift\" action=\"bypass -h admin_ctf_gift $input1\" width=90 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		replyMSG.append("<td width=\"100\"><button value=\"Gift Amount\" action=\"bypass -h admin_ctf_gift_amount $input1\" width=90 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		replyMSG.append("</tr></table><br><table><tr>");
		replyMSG
	...
	public void showMainPage(L2PcInstance activeChar)
	{
		...
		replyMSG.append("Gift ID:&nbsp;<font color=\"00FF00\">" + CTF._giftId + "</font><br1>");
		replyMSG.append("Gift Amount:&nbsp;<font color=\"00FF00\">" + CTF._giftAmount + "</font><br><br>");
