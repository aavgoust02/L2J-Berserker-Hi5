...
public abstract class L2Character extends L2Object
{
		...
		switch (skill.getTargetType())
		{
			...
			default:
				...
				if (doit)
				{
					...
					if (Config.STOP_RAID_HEALING && skill.getSkillType() == L2SkillType.HEAL && target instanceof L2Attackable)
					{
						L2Attackable _target = (L2Attackable)target;
						if (!_target.canBeHealed())
						{
							this.sendMessage("Healing the raid boss is not allowed.");
							target = null;
						}
					}
				}
	...
	public boolean isAttackingDisabled() { return isFlying() || isStunned() || isSleeping() || _attackEndTime > GameTimeController.getGameTicks() || isAlikeDead() || isParalyzed() || isPhysicalAttackMuted() || isCoreAIDisabled(); }
