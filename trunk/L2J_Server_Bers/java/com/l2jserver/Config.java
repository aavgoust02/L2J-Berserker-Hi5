...
public final class Config
{
	...
	public static String    TVT_EVEN_TEAMS;
		...
		public static boolean   RAID_ANNOUNCE_REWARD;
		public static boolean   RAID_ON_START_REMOVE_ALL_EFFECTS;
		public static boolean   RAID_ON_START_UNSUMMON_PET;
		public static boolean   RAID_JOIN_CURSED;
		public static boolean   RAID_ALLOW_INTERFERENCE;
		...
		public static int				SERVER_MAX_ENCHANT;
		public static boolean			HACKER_PROTECTION;
		public static boolean   		WEDDING_GIVE_CUPID_BOW;
		public static boolean   		DISABLE_ELEMENT_ENCHANTING;
		public static boolean   		SPAWN_SIEGE_GUARD;
		public static boolean   		STOP_RAID_HEALING;
		...
		if(Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			try
			{
				try
				{
					...
					String[] protocols = serverSettings.getProperty("AllowedProtocolRevisions", "146;152;216").split(";");
	...
	public static boolean setParameterValue(String pName, String pValue)
	{
		...
		else if (pName.equalsIgnoreCase("TVTReviveDelay")) TVT_REVIVE_DELAY = Long.parseLong(pValue);
		...
		else if (pName.equalsIgnoreCase("RaidAllowInterference")) RAID_ALLOW_INTERFERENCE = Boolean.parseBoolean(pValue);
		...
		else if (pName.equalsIgnoreCase("DMReviveDelay")) DM_REVIVE_DELAY = Long.parseLong(pValue);
		else if (pName.equalsIgnoreCase("ServerMaxEnchant")) SERVER_MAX_ENCHANT = Integer.parseInt(pValue);  
		else if (pName.equalsIgnoreCase("HackerProtection")) HACKER_PROTECTION = Boolean.parseBoolean(pValue);  
		else if (pName.equalsIgnoreCase("StopRaidHealing")) STOP_RAID_HEALING = Boolean.parseBoolean(pValue);
		else if (pName.equalsIgnoreCase("ShowLegend")) SHOW_LEGEND = Boolean.parseBoolean(pValue);
		else if (pName.equalsIgnoreCase("ShowKarmaPlayers")) SHOW_KARMA_PLAYERS = Boolean.parseBoolean(pValue);
		else if (pName.equalsIgnoreCase("ShowJailedPlayers")) SHOW_JAILED_PLAYERS = Boolean.parseBoolean(pValue);
		else
		{
			try
			{
